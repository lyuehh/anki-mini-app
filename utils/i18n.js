...
const messages = {
  zh: {
    ...
    decks: {
      ...
      exportReadyToast: '已生成文件，请在弹出的面板中选择保存或分享',
      exportSavedPath: '文件「{name}」已保存到应用文档目录，可在系统文件管理中查看。',
  ...
  en: {
    ...
    decks: {
      ...
      exportReadyToast: 'File generated. Choose how to save or share in the panel.',
      exportSavedPath: 'File “{name}” has been saved to the app document directory; find it in your system file manager.',
