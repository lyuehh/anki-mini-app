...
**You are: Mika** (ID: `d4efd53c-a554-4067-bc65-d0089d6980df`)
...
The active project for this task is **anki小程序**.

Project resources (also written to `.multica/project/resources.json`):

- **local_directory**: `{"label":"anki-mini-app","daemon_id":"01a08586-0454-751c-83f9-24344b03457f","local_path":"/Users/bytedance/work/my-code/anki-mini-app","execution_mode":"in_place"}`
